      ...
      <div className="flex flex-col md:px-20">
        <div>
          <div className="grid md:grid-cols-2  justify-start   pt-4 pb-4">
            ...
            <div className="text-[1rem] leading-[1.5rem] text-justify pt-6 md:text-[1.1rem] text-[#333] tracking-wider md:leading-[2.2rem]">
          ...
          <div className="text-[1rem] leading-[1.5rem] text-justify pt-2 md:text-[1.1rem] text-[#333] tracking-wider md:leading-[2.2rem]">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex flex-col md:grid md:grid-cols-3 md:grid-rows-2 gap-2 pt-8  ">
            <div className="flex flex-col items-center gap-4 p-8 hover:shadow-xl shadow-[#333] hover:scale-110 ease-in-out duration-500 rounded-md">
              <div>
                <SiAtom className="text-[#0d3a15] h-[3.5rem] w-[3.5rem]  md:h-[5rem] md:w-[5rem] " />
              </div>
              <div className="text-center md:text-left">
            ...
            <div className="flex flex-col items-center gap-4 p-8 hover:shadow-xl shadow-[#333] hover:scale-110 ease-in-out duration-700 rounded-md">
              <div>
                <RiRobot2Line className="text-[#0d3a15] h-[3.5rem] w-[3.5rem]  md:h-[5rem] md:w-[5rem] " />
              </div>
              <div className="text-center md:text-left">
            ...
            <div className="flex flex-col items-center gap-4 p-8 hover:shadow-xl shadow-[#333] hover:scale-110 ease-in-out duration-700 rounded-md">
              <div>
                <FaUniversity className="text-[#0d3a15] h-[3.5rem] w-[3.5rem]  md:h-[5rem] md:w-[5rem] " />
              </div>
              <div className="text-center md:text-left">
            ...
            <div className="flex flex-col items-center gap-4 p-8 hover:shadow-xl shadow-[#333] hover:scale-110 ease-in-out duration-700 rounded-md">
              <div>
                <BsFileEarmarkSpreadsheet className="text-[#0d3a15] h-[3.5rem] w-[3.5rem]  md:h-[5rem] md:w-[5rem] " />
              </div>
              <div className="text-center md:text-left">
            ...
            <div className="flex flex-col items-center gap-4 p-8 hover:shadow-xl shadow-[#333] hover:scale-110 ease-in-out duration-700 rounded-md">
              <div>
                <PiTreeFill className="text-[#0d3a15] h-[3.5rem] w-[3.5rem]  md:h-[5rem] md:w-[5rem] " />
              </div>
              <div className="text-center md:text-left">
          ...
          <div className="grid md:grid-cols-3 md:grid-rows-2 gap-7">
            <div className="flex flex-col items-center gap-4 shadow-lg text-center md:text-left shadow-[#adacac] rounded-b-2xl md:p-16 p-4 hover:scale-110  ease-in-out duration-700">
              <div>
                ...
                <img
                  src={img1}
                  className="h-[12.5rem] w-[13rem] rounded-full md:h-[15rem] md:w-[20rem] object-cover brightness-75"
                  alt="card1"
                />
              </div>
              <div className="text-[0.9rem] px-[2rem] md:text-[1.2rem]">
                Bringing together a community of people with shared concerns for
                a sustainable agri-food system in the region.
              </div>
            </div>
            <div className="flex flex-col items-center gap-4 shadow-lg text-center md:text-left shadow-[#adacac] rounded-b-2xl px-[2rem] md:p-16 p-4 hover:scale-110  ease-in-out duration-700">
              <div>
                {" "}
                <img
                  src={img2}
              ...
              <div className="text-[0.9rem] md:text-[1.2rem]">
            ...
            <div className="flex flex-col items-center gap-4 shadow-lg text-center md:text-left shadow-[#adacac] rounded-b-2xl px-[4rem] md:p-16 p-4 hover:scale-110  ease-in-out duration-700">
              <div>
                {" "}
                <img
                  src={img6}
